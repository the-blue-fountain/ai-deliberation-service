# Generated by Django 5.1.2 on 2025-11-07 13:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grader_objective_questions', models.JSONField(blank=True, default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grader_responses', to='core.discussionsession')),
            ],
            options={
                'ordering': ('-submitted_at',),
                'constraints': [models.UniqueConstraint(fields=('session', 'user_id'), name='unique_discussion_grader_response_per_user')],
            },
        ),
        migrations.CreateModel(
            name='GraderResponse',
